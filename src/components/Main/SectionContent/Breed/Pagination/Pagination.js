...
const Pagination = (props) => {
  const picsNumber = props.breedImages1 ? props.breedImages1.length : props.breedImages2.length
  const picsPerPage = 8
  const pages = Math.ceil(picsNumber / picsPerPage)
  ...
  useEffect(() => {
    ...
    // }
      ...
      setCurrentBtn(arrOfCurrentBtns[2] - 2)
    }
  ...
  return (
    <div className="h2 pagination_container">
      ...
      <a
        href="#"
        onClick={() => setCurrentBtn((prev) => prev === numberOfPages.length ? prev : prev + 1)}
